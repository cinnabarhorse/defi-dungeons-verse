-- Function to atomically credit a deposit to a player
-- Used by Goldsky webhook and admin tools
...
begin
  ...
  if v_player_id is null then
    ...
    from public.players
    where lower(unique_wallet_address) = lower(v_deposit.depositor_address)
    limit 1;
  end if;
  ...
  -- Log transaction (economy_ledger)
  -- Note: We assume economy_ledger table exists as per other migrations
