 ...
 *
 * Client Enemy Sprite Configs Data - Generated from /data/enemy-sprite-configs.ts
 * This file is automatically synced to ensure consistency.
 *
 * To make changes, edit /data/enemy-sprite-configs.ts and run: npm run generate:shared
 */
