 ...
 *
 * Server Spells Data - Generated from /data/spells.ts
 * This file is automatically synced from /data/spells.ts.
 *
 * To make changes, edit /data/spells.ts and run: npm run generate:shared
 */
